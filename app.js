...
// Phone back button / browser back — intercept popstate
window.addEventListener('popstate', function(e){
  ...
  // Close legal panels if any open
...
function applyHomepageContent(d){
  ...
  if(d.hero_sub){
    document.getElementById('heroSub').innerHTML = d.hero_sub.replace(/\n/g,'<br>');
  }
  ...
  if(d.loc_full){
    document.getElementById('locFull').innerHTML = d.loc_full.replace(/\n/g,'<br>');
  }
  ...
  wrap.innerHTML = posts.map(p=>`
    <div class="bcard" onclick="openBlogPost('${p.id}')">
      ...
      <div class="bcard-body">
        <div class="bcard-date">${fmtDate(p.created_at)}</div>
...
function openBlogPost(id){
  ...
  document.getElementById('readerDate').textContent = fmtDate(post.created_at);
  document.getElementById('readerTitle').textContent = post.title;
  document.getElementById('readerContent').textContent = post.content||'';
...
function openCart(){renderDrawer();document.getElementById('cartOverlay').classList.add('open');document.body.style.overflow='hidden'}
  ...
  wrap.innerHTML = posts.map(p=>`
    <div class="adm-mitem">
      ...
      <div class="adm-mitem-info">
        ...
        <div class="adm-mitem-cat">${fmtDate(p.created_at)}</div>
